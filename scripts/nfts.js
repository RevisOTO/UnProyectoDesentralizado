...
async function createImgInfo() {
  ...
  const stream = fs.createReadStream("./images/JONNHY_TRISTE.jpg")
...
async function createJsonInfo() {
  const metadata = {
    image: "https://gateway.pinata.cloud/ipfs/Qma4qwK9dynyxBTPmkBja85ML7UgFakMJyfw67y7UVoynD",
    name: "JONNHY TRISTE",
    description: "ESTA TITE QUE ALGUIEN LE DE UN ABACHO :c",
    attributes: [
...
async function mintNFT() {
  ...
  const transaction = {
    ...
    data: etherInterface.encodeFunctionData("mintNFT",
      [PUBLIC_KEY, "https://gateway.pinata.cloud/ipfs/QmavbJzFFtER8dWFGpZaio6BocKQpRwA86q2qJPC8kVEr3"])
  }
